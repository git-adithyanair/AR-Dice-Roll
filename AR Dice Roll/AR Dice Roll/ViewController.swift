...
//  ARDicee
//
//  Created by Adithya Nair on 1/20/20.
...
//        sceneView.scene.rootNode.addChildNode(node)
    ...
    @IBAction func rollPressed(_ sender: UIBarButtonItem) { rollAll() }
    ...
    override func motionEnded(_ motion: UIEvent.EventSubtype, with event: UIEvent?) { rollAll() }
